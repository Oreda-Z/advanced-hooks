...
const ProgrammablActionsExample = () => {
    ...
    return (
        <CardWrapper>
            ...
            <button className={"btn btn-primary mx-2"} onClick={handleClick}>Фокус input</button>
            <button className={"btn btn-secondary mx-2"} onClick={handleClickWidth}>Изменить ширину объекта</button>
        </CardWrapper>
    );
};
